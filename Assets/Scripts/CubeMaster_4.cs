...
public class CubeMaster_4 : MonoBehaviour
{
    static Material lineMaterial;
    public Vector3 myPerp;
    ...
    public void OnRenderObject()
    {
        ...
        GL.Vertex(tPosDotxz);//x,z component of object position

        Color color3 = Color.green;
        GL.Color(color3);
        GL.Vertex(Vector3.zero+POS);//world origin
        GL.Vertex(myPerp+POS);//end of the vector perpendicular to both POS and tPosxz
